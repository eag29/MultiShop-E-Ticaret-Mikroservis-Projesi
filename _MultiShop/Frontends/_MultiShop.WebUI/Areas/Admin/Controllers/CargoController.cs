...
using _MultiShop.WebUI.Services.CargoServices.CargoCompanyService;
...
namespace _MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class CargoController : Controller
    {
        ...
        public async Task<IActionResult> UpdateCargoCompany(UpdateCargoCompanyDto updateCargoCompanyDto)
        {
            ...
            return RedirectToAction("UpdateCargoCompany", "Cargo", new { Area = "Admin" });
        }
        [HttpDelete]
        ...
        public async Task<IActionResult> DeleteCargoCompany(int id)
        {
            ...
            return RedirectToAction("DeleteCargoCompany", "Cargo", new { Area = "Admin" });
        }
    }
}
